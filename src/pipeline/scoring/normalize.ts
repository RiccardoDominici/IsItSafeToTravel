 ...
 * UCDP: 0 to N (lower = fewer conflicts = safer)
...
const INDICATOR_RANGES: Record<string, { min: number; max: number; inverse: boolean }> = {
  ...
  // UCDP conflict data (lower = safer)
  ucdp_fatalities: { min: 0, max: 10000, inverse: true },
  ucdp_events: { min: 0, max: 5000, inverse: true },
