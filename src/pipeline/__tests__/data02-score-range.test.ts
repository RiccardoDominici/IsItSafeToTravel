...
const COUNTRY: CountryEntry = { iso3: 'TST', iso2: 'TS', name: { en: 'Test', it: 'Test', es: 'Test', fr: 'Test', pt: 'Test' } };
...
describe('DATA-02: composite score is always in 1-10 range', () => {
  ...
  it('score is 1-10 with worst-case indicators', () => {
    ...
    const indicators: RawIndicator[] = [
      ...
      makeIndicator('gdelt_instability', 1.0),  // worst
  ...
  it('score is 1-10 with best-case indicators', () => {
    ...
    const indicators: RawIndicator[] = [
      ...
      makeIndicator('gdelt_instability', 0),    // best
